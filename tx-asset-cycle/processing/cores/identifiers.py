...
class CycleRecordFactory:
    ...
    def create_base_params(
        ...
        return {
            ...
            "current_asset_longitude": curr_rec.longitude,
            "current_asset_latitude": curr_rec.latitude,
            ...
            "load_region_guid": last_rec.load_region_guid,
            "is_within_load_region": last_rec.is_within_load_region,
            "asset_load_region_distance": last_rec.asset_load_region_distance,
            ...
            "tmp_idle_near_loader": last_rec.tmp_idle_near_loader,
            "dump_region_guid": last_rec.dump_region_guid,
            "outlier_type_id": last_rec.outlier_type_id,
            "all_assets_in_same_dump_area": (
                last_rec.all_assets_in_same_dump_area
            ),
            "outlier_date_utc": last_rec.outlier_date_utc,
            "outlier_loader_guid": last_rec.outlier_loader_guid,
            "outlier_loader_latitude": last_rec.outlier_loader_latitude,
            "outlier_loader_longitude": last_rec.outlier_loader_longitude,
            "outlier_dump_region_guid": last_rec.outlier_dump_region_guid,
    ...
    def create_new_cycle_params(
        ...
        return {
            ...
            "load_region_guid" : (
                context.nearest_load_region.region_guid if loader_rec else None
            ),
            "is_within_load_region" : (
                context.is_truck_within_load_region if loader_rec else False
            ),
            "asset_load_region_distance" : (
                context.distance_truck_with_load_region if loader_rec else None
            ),
